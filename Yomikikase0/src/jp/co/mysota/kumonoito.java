...
public class kumonoito
{
	...
	//@<Separate/>
	public void talk()																									//@<BlockInfo>jp.vstone.block.func,0,112,976,352,False,23,@</BlockInfo>
	throws SpeechRecogAbortException {
		if(!GlobalVariable.TRUE) throw new SpeechRecogAbortException("default");

																														//@<OutputChild>
		GlobalVariable.sotawish.Say((String)"青空文庫　芥川龍之介　の　蜘蛛の糸　を読みます．",MotionAsSotaWish.MOTION_TYPE_TALK,(int)11,(int)13,(int)11);	//@<BlockInfo>jp.vstone.block.talk.say,144,112,144,112,False,22,@</BlockInfo>
																														//@<EndOfBlock/>
