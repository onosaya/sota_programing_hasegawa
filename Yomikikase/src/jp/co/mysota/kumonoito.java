...
public class kumonoito
{
	...
	public kumonoito()																									//@<BlockInfo>jp.vstone.block.func.constructor,16,16,144,16,False,2,@</BlockInfo>
	{
																														//@<OutputChild>
	...
	//@<Separate/>
	public void talk()																									//@<BlockInfo>jp.vstone.block.func,48,144,944,144,False,23,@</BlockInfo>
	throws SpeechRecogAbortException {
		if(!GlobalVariable.TRUE) throw new SpeechRecogAbortException("default");

																														//@<OutputChild>
		GlobalVariable.sotawish.Say((String)"青空文庫　芥川龍之介　の　蜘蛛の糸　を読みます．",MotionAsSotaWish.MOTION_TYPE_TALK,(int)11,(int)13,(int)11);	//@<BlockInfo>jp.vstone.block.talk.say,176,144,176,144,False,22,@</BlockInfo>
																														//@<EndOfBlock/>
		pose = new CRobotPose();																						//@<BlockInfo>jp.vstone.block.pose,240,144,240,144,False,21,コメント@</BlockInfo>
