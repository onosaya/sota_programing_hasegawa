...
public class mgirl
{
	...
	//@<Separate/>
	public void talk()																									//@<BlockInfo>jp.vstone.block.func,80,208,704,208,False,24,@</BlockInfo>
	throws SpeechRecogAbortException {
		if(!GlobalVariable.TRUE) throw new SpeechRecogAbortException("default");

																														//@<OutputChild>
		GlobalVariable.sotawish.Say((String)"青空文庫　マッチ売りの少女　を読みます．",MotionAsSotaWish.MOTION_TYPE_TALK,(int)11,(int)13,(int)11);	//@<BlockInfo>jp.vstone.block.talk.say,208,208,208,208,False,23,@</BlockInfo>
																														//@<EndOfBlock/>
		pose = new CRobotPose();																						//@<BlockInfo>jp.vstone.block.pose,272,208,272,208,False,22,コメント@</BlockInfo>
